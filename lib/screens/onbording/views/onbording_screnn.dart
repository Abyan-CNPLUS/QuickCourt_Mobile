...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    Onbord(
      ...
      description:
          "Here you’ll see many varient of mini soccer fields.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration-1.png",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_1.png",
      title: "Get those mini soccer field \nand find your favorite field",
      description:
    ...
    Onbord(
      ...
      title: "Nearby venue",
      description:
          "Easily find venue nearby your home, browse through their items and get information about their venue.",
    ),
  ];
